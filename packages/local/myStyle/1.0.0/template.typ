...
#let init-subfile(
  ...
  show footnote.entry: it => context {
    ...
    let n = numbering("1", ..counter(footnote).at(loc))
  ...
  show heading.where(level: 1): it => {
    ...
    let pre-chapter = {
      ...
      if l == "ja" [
        ...
        第#numbering(local-numbering, ..counter(heading).at(it.location()))章
      ] else [
        ...
        pad(
          ...
          block(
            ...
            height: 25 * (s + l),
            {
              ...
              stack(
                dir: ttb,
                stack(dir: ltr, h(60%), box(width: 10%, strong(heading.at("date"))), box(width: 30%, date)),
                stack(
                  dir: ltr,
